...
"Agent team" means Claude Code's Agent Teams (https://code.claude.com/docs/en/agent-teams), not the Agent tool's subagent pattern. Read those docs before spawning or coordinating teammates.
