...
# 
# # # if not exists ~/git/lens/provision
# # # git clone https://github.com/lens0021/provision ~/git/lens/provision
# # # else if shallow
# # #   cd ~/git/lens/provision
# # #   git fetch --unshallow
# # # fi
# # mkdir -p ~/.config/bin
# # ln -s $HOME/git/lens/provision/config/bin.config $HOME/.config/bin/config.json
# 
# # mkdir -p /home/nemo/.local/bin
# # curl -Lo bin https://github.com/marcosnils/bin/releases/download/v0.21.2/bin_0.21.2_linux_amd64
# # chmod +x bin
# # ./bin ensure bin
# 
